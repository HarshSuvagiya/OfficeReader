...
//            SheetbarResConstant.RESNAME_SHEETBUTTON_FOCUS_RIGHT);
        ...
        //sheetbar background
        sheetbarBG =  context.getResources().getDrawable(R.drawable.ss_sheetbar_bg);

        //shadow
        sheetbarLeftShadow =  context.getResources().getDrawable(R.drawable.ss_sheetbar_shadow_left);
        sheetbarRightShadow =  context.getResources().getDrawable(R.drawable.ss_sheetbar_shadow_right);

        //hSeparator
        hSeparator =  context.getResources().getDrawable(R.drawable.ss_sheetbar_separated_horizontal);

        //normal state
        normalLeft =  context.getResources().getDrawable(R.drawable.ss_sheetbar_button_normal_left);
        normalRight = context.getResources().getDrawable(R.drawable.ss_sheetbar_button_normal_right);
        normalMiddle = context.getResources().getDrawable(R.drawable.ss_sheetbar_button_normal_middle);

        //push state
        pushLeft = context.getResources().getDrawable(R.drawable.ss_sheetbar_button_push_left);
        pushRight = context.getResources().getDrawable(R.drawable.ss_sheetbar_button_push_right);
        pushMiddle = context.getResources().getDrawable(R.drawable.ss_sheetbar_button_push_middle);

        //focus state
        focusLeft = context.getResources().getDrawable(R.drawable.ss_sheetbar_button_focus_left);
        focusRight = context.getResources().getDrawable(R.drawable.ss_sheetbar_button_focus_right);
        focusMiddle = context.getResources().getDrawable(R.drawable.ss_sheetbar_button_focus_middle);
