...
public class PictureEffectInfoFactory
{
    ...
    public static PictureEffectInfo getPictureEffectInfor(Element blipFill)
    {
        ...
        if(e != null)
        {
            ...
            if(value != null)
            {
                int kju= 0;
                try {
                    kju = Integer.parseInt(value);
                } catch (NumberFormatException ex) {
                    ex.printStackTrace();
                }
                validateInfor = true;
                effectInfor.setBlackWhiteThreshold(kju / 100000f * 255);
            }
        }
        ...
        if(e != null)
        {
            ...
            if(value != null)
            {
                ...
                float b= 0;
                try {
                    b = Integer.parseInt(value) / 100000f;
                } catch (NumberFormatException ex) {
                    ex.printStackTrace();
                }
            ...
            if(value != null)
            {
                ...
                float c= 0;
                try {
                    c = Integer.parseInt(value) / 100000f;
                } catch (NumberFormatException ex) {
                    ex.printStackTrace();
                }
                if(c > 0)
    ...
    public static PictureEffectInfo getPictureEffectInfor(com.wxiwei.office.fc.hwpf.usermodel.Picture pic)
    {
    	if(pic == null)
        {
            return null;
