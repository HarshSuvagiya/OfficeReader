...
public class AutoShapeDataKit
{
    ...
    public static int getColor(Map<String, Integer> schemeColor, Element solidFillElement)
    {
        ...
        else if((clr = solidFillElement.element("scrgbClr")) != null)
        {
            int r = 0;
            try {
                r = Integer.parseInt(clr.attributeValue("r")) * 255 / 100;
            } catch (NumberFormatException e) {
                e.printStackTrace();
            }
            int g = 0;
            try {
                g = Integer.parseInt(clr.attributeValue("g")) * 255 / 100;
            } catch (NumberFormatException e) {
                e.printStackTrace();
            }
            int b = 0;
            try {
                b = Integer.parseInt(clr.attributeValue("b")) * 255 / 100;
            } catch (NumberFormatException e) {
                e.printStackTrace();
            }
            ...
            || solidFillElement.element("prstClr") != null)
        {
            if (schemeColor != null && schemeColor.size() > 0)
            {
                ...
                if (clr.element("tint") != null)
                {
                    int kju = 0;
                    try {
                        kju = Integer.parseInt(clr.element("tint").attributeValue("val"));
                    } catch (NumberFormatException e) {
                        e.printStackTrace();
                    }
                    color = ColorUtil.instance().getColorWithTint(color, kju / 100000.0);
                }
                else if (clr.element("lumOff") != null)
                {
                    int kju = 0;
                    try {
                        kju = Integer.parseInt(clr.element("lumOff").attributeValue("val"));
                    } catch (NumberFormatException e) {
                        e.printStackTrace();
                    }
                ...
                else if (clr.element("lumMod") != null)
                {
                    int kju= 0;
                    try {
                        kju = Integer.parseInt(clr.element("lumMod").attributeValue("val"));
                    } catch (NumberFormatException e) {
                        e.printStackTrace();
                    }
                    color = ColorUtil.instance().getColorWithTint(color, 
                ...
                else if (clr.element("shade") != null)
                {
                    int kju= 0;
                    try {
                        kju = Integer.parseInt(clr.element("shade").attributeValue("val"));
                    } catch (NumberFormatException e) {
                        e.printStackTrace();
                    }
                    color = ColorUtil.instance().getColorWithTint(color, 
                ...
                if(clr.element("alpha") != null)
                {
                    ...
                    if(val != null)
                    {
                        int alpha = 0;
                        try {
                            alpha = (int)(Integer.parseInt(val) / 100000f * 255);
                        } catch (NumberFormatException e) {
                            e.printStackTrace();
                        }
