...
==================================================================== */
package com.wxiwei.office.fc.poifs.crypt;
...
import com.wxiwei.office.fc.codec.Base64;
...
public class EncryptionHeader {
    ...
    public EncryptionHeader(String descriptor) throws IOException {
        ...
        int hashSize = 0;
        try {
            hashSize = Integer.parseInt(keyData.getNamedItem("hashSize")
                                            .getNodeValue());
        } catch (NumberFormatException e) {
            e.printStackTrace();
        } catch (DOMException e) {
        ...
        int saltLength = 0;
        try {
            saltLength = Integer.parseInt(keyData.getNamedItem("saltSize")
                                              .getNodeValue());
        } catch (NumberFormatException e) {
            e.printStackTrace();
        } catch (DOMException e) {
