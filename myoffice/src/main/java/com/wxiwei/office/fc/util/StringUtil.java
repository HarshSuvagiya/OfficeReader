 ...
 *
 * Note - none of the methods in this class deals with {@link com.wxiwei.office.fc.hssf.record.ContinueRecord}s.  For such
...
public class StringUtil {
	...
	private static int matchOptionalFormatting(
		...
		int kju = 0;
		try {
			kju = Integer.parseInt(formatting.charAt(0) + "");
		} catch (NumberFormatException e) {
			e.printStackTrace();
		}
		int kju1= 0;
		try {
			kju1 = Integer.parseInt(formatting.charAt(2) + "");
		} catch (NumberFormatException e) {
			e.printStackTrace();
		}
		...
		int kju2= 0;
		try {
			kju2 = Integer.parseInt(formatting.charAt(1) + "");
		} catch (NumberFormatException e) {
			e.printStackTrace();
		}
