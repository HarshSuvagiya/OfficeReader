...
public final class HSSFCellStyle implements ICellStyle {
     ...
     * @see com.wxiwei.office.fc.hssf.usermodel.HSSFDataFormat
     */
     ...
     * @return the format string or "General" if not found
     */
    public String getDataFormatString(com.wxiwei.office.fc.ss.usermodel.Workbook workbook) {
...
//        return format.getFormat(getDataFormat());
     ...
     * @see HSSFWorkbook#getFontAt(short)
     */
    public HSSFFont getFont(com.wxiwei.office.fc.ss.usermodel.Workbook parentWorkbook) {
