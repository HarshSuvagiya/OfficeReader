            ...
            if (spcBef != null)
            {
                ...
                if (temp != null && temp.attribute("val") != null)
                {
                    ...
                    if (val != null && val.length() > 0)
                    {
                        int kju= 0;
                        try {
                            kju = Integer.parseInt(val);
                        } catch (NumberFormatException e) {
                            e.printStackTrace();
                        }
                        AttrManage.instance().setParaBefore(attr, (int) (kju
                                                     / 100 * MainConstant.POINT_TO_TWIPS));
                    }
                }
            }
            else
                ...
                if (temp != null && temp.attribute("val") != null)
                {
                    ...
                    if (val != null && val.length() > 0)
                    {
                        ...
                        AttrManage.instance().setParaAfter(attr, 
                            (int)( kju/ 100 * MainConstant.POINT_TO_TWIPS));
                    }
                }
            }
            else
            ...
            if (lnSpc != null)
            {
                ...
                if (temp != null && temp.attribute("val") != null)
                {
                    ...
                    if (val != null && val.length() > 0)
                    {
                        ...
                        AttrManage.instance().setParaLineSpace(attr, (float)( kju- lnSpcReduction) / 100000);
                    }
                }
            }
            else
