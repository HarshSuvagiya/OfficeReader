...
import com.wxiwei.office.fc.codec.DigestUtils;
 ...
 */
public final class HSSFWorkbook extends POIDocument implements com.wxiwei.office.fc.ss.usermodel.Workbook
{
     ...
     *        in memory
     * @see com.wxiwei.office.fc.poifs.filesystem.POIFSFileSystem
...
//            names.add(name);
     ...
     */
    public int getSheetIndex(com.wxiwei.office.fc.ss.usermodel.Sheet sheet)
    {
...
//        return newName;
     ...
     * @see com.wxiwei.office.fc.hssf.record.FormatRecord
     * @see Record
     */
