...
public class HorizontalViewActivity extends FragmentActivity {
    ...
    TextView toastBrightnessText, floatingBookmarkTextView, /*maxSeek, currentSeek, */
            pagesCountIndicator, flippingIntervalView, pagesTime, pagesTime1, pagesPower, titleTxt, chapterView, /*modeName,*/
            pannelBookTitle;
    View adFrame, bottomBar, bottomIndicators, /*onClose, */
            overlay, pagesBookmark, musicButtonPanel, parentParent;
    LinearLayout actionBar, bottomPanel;
    TTSControlsView ttsActive;
    FrameLayout anchor;
    //    UnderlineImageView /*onCrop, */onBC;
    ImageView onBC, onShowSearch, thumbnail, bookNight, bookPref;
    LinearLayout option_lay;
    ImageView moveCenter, lockModelImage, /*linkHistory, */
            onModeChange, /*outline, */
    /*onMove, */textToSpeach, onPageFlip1, anchorX, anchorY;
...
//                DragingDialogs.pageFlippingDialog(anchor, dc, onRefresh);
                if (dc == null) {
                    MyUtils.Toast(HorizontalViewActivity.this, "File is Corrupted try Another File");
                    finish();
                    return;
                }
                DragingDialogs.mypageFlippingDialog(dc.getActivity(), dc, onRefresh);
            }
        });
...
/*        onFullScreen.setOnClickListener(new OnClickListener() {
        ...
        LinearLayout.LayoutParams layoutParams = MyUtils.getParamsLSquare(this, 96);
        int w = getResources().getDisplayMetrics().widthPixels * 50 / 1080;
        layoutParams.leftMargin = w;
        dayNightButton.setLayoutParams(layoutParams);
        ...
        option_lay = findViewById(R.id.option_lay);
        bookNight = findViewById(R.id.bookNight);
        bookPref = findViewById(R.id.bookPref);
        onBC = findViewById(R.id.onBC);
        onBC.setVisibility(View.GONE);
        thumbnail = findViewById(R.id.thumbnail);
        onShowSearch = findViewById(R.id.onShowSearch);
//        onBC.underline(AppState.get().isEnableBC);
...
//                DragingDialogs.contrastAndBrigtness(anchor, dc, reloadDocBrigntness, reloadDoc);
                ...
                Dialog dialog = new Dialog(dc.getActivity());
                ...
                LinearLayout.LayoutParams layoutParams = MyUtils.getParamsL(dc.getActivity(), 856, 504);
...
//                        dc.updateRendering();
                ...
                ImageView imgcontrast, imgbright;
                imgcontrast = dialog.findViewById(R.id.imgcontrast);
                imgbright = dialog.findViewById(R.id.imgbright);

                layoutParams = MyUtils.getParamsLSquare(dc.getActivity(), 54);
                btncheck.setLayoutParams(layoutParams);
                layoutParams = MyUtils.getParamsLSquare(dc.getActivity(), 90);
                imgbright.setLayoutParams(layoutParams);
                imgcontrast.setLayoutParams(layoutParams);
        ...
        dayNightButton.setImageResource(!AppState.get().isDayNotInvert ? R.drawable.nightmodepress_button : R.drawable.nightmode_button);
...
//                DragingDialogs.gotoPageDialog(anchor, dc);
                ...
                DragingDialogs.mygotoPageDialog(dc.getActivity(), dc, new OnCommonProgress() {
                    @Override
        ...
        onShowSearch.setOnClickListener(new View.OnClickListener() {
...
//                DragingDialogs.textToSpeachDialog(anchor, dc);
                textToSpeach.setImageResource(R.drawable.voicepress_button);
                DragingDialogs.mytexttospeechDialog(dc.getActivity(), dc, new OnCommonProgress() {
                    @Override
                    public void OnComplete(Boolean iscomplete, Object object) {
                        textToSpeach.setImageResource(R.drawable.voicepress_button);
                    }
        ...
        onModeChange = findViewById(R.id.onModeChange);
...
//        modeName.setOnLongClickListener(onCloseLongClick);
        ...
        layoutParams = MyUtils.getParamsLSquare(this, 96);
        w = getResources().getDisplayMetrics().widthPixels * 50 / 1080;
        layoutParams.leftMargin = w;
        findViewById(R.id.bookPref).setLayoutParams(layoutParams);
...
//                    DragingDialogs.preferences(anchor, dc, onRefresh, reloadDoc);
                    ...
                    txt_sys.setTypeface(Typeface.createFromAsset(getAssets(),"arial.ttf"));
                    txt_nav.setTypeface(Typeface.createFromAsset(getAssets(),"arial.ttf"));
                    txt_rev.setTypeface(Typeface.createFromAsset(getAssets(),"arial.ttf"));
                    ...
                    final int systemBrigtnessInt = BrightnessHelper.getSystemBrigtnessInt(dc.getActivity());
                    int value = 0;
...
//                            DragingDialogs.textToSpeachDialog(anchor, dc);
    ...
    private void resize() {
        ...
        Help1.setSize(bookNight, 80, 80, false);
        Help1.setSize(bookPref, 80, 80, false);
        Help1.setMargin(onBC, 110, 0, 0, 0, false);
        Help1.setMargin(bookNight, 110, 0, 0, 0, false);
        Help1.setMargin(bookPref, 110, 0, 0, 0, false);

        Help1.setSize(onShowSearch, 270, 180, false);
        Help1.setSize(thumbnail, 270, 180, false);
        Help1.setSize(onModeChange, 270, 180, false);
        Help1.setSize(lockModelImage, 270, 180, false);

        LinearLayout laybottom = findViewById(R.id.laybottom);
...
//        onModeChange.setImageResource(R.drawable.glyphicons_two_page_one);
    ...
    public void onFlippingStart(FlippingStart event) {
        ...
        onPageFlip1.setImageResource(R.drawable.pause_button4);
    }
    ...
    public void onFlippingStop(FlippingStop event) {
        ...
        onPageFlip1.setImageResource(R.drawable.play_button4);
...
//        DragingDialogs.searchMenu(anchor, dc, "");
        onShowSearch.setImageResource(R.drawable.page_searchpress);
        DragingDialogs.mysearchMenu(this, dc, new OnCommonProgress() {
            @Override
            public void OnComplete(Boolean iscomplete, Object object) {
                onShowSearch.setImageResource(R.drawable.page_search);
            }
        });
    }
    ...
    public void updateLockMode() {
        if (AppSP.get().isLocked) {
            lockModelImage.setImageResource(R.drawable.lock_button);
        } else {
            lockModelImage.setImageResource(R.drawable.unlock_button);
        }
//        if (AppState.get().l) {
    ...
    public void hideShow(boolean animated) {
      ...
      /*  if (BuildConfig.IS_BETA && animated) {
        ...
        if (!animated || AppState.get().appTheme == AppState.THEME_INK) {
            ...
            bottomBar.setVisibility(AppState.get().isEditMode ? View.VISIBLE : View.INVISIBLE);
...
//                dc.saveCurrentPageAsync();
  ...
  /*  @Override
    ...
    private void loadInterstitial() {
        ...
        interstitialAd.setAdUnitId(getString(R.string.admob_fullscreen_horizonatlview_id));
